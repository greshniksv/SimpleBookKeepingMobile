...
# Rename the APK file
Rename-Item -Path ".\publish\com.greshniksv.simplebookkeepingmobile-Signed.apk" -NewName "SimpleBookKeepingMobile.apk"

# Execute FileRenamer if it exists
if (Test-Path $REN_EXE_PATH) {
    & $REN_EXE_PATH ".\SimpleBookKeepingMobile\SimpleBookKeepingMobile.csproj" ".\publish\SimpleBookKeepingMobile.apk"
} else {
