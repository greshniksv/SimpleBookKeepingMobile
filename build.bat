...
ren ".\publish\com.greshniksv.simplebookkeepingmobile-Signed.apk" "SimpleBookKeeping.apk"

if exist "%REN_EXE_PATH%" (
    "%REN_EXE_PATH%" ".\SimpleBookKeepingMobile\SimpleBookKeepingMobile.csproj" ".\publish\SimpleBookKeeping.apk"
) else (
